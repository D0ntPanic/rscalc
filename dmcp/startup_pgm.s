...
/* Ensure all symbols from QSPI section are included */
	ldr r0, =__bid_mod10_18_tbl
    ldr r0, =__bid_convert_table
    ldr r0, =__bid128_pow
    ldr r0, =__bid128_sin
    ldr r0, =__bid128_cos
    ldr r0, =__bid128_tan
    ldr r0, =__binary32_to_bid64
    ldr r0, =__bid32_to_binary128
